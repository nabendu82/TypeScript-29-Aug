...
const AddToPeople: React.FC<IProps> = ({ setPeople, people }) => {
    ...
    const handleClick = () => {
        ...
        setPeople([...people, { name: input.name, age: Number(input.age), note: input.note, img: input.img }])
    ...
    return (
        <div className='add-people'>
            ...
            <textarea onChange={handleChange} className="add-input" name="note" value={input.note} placeholder="Note"></textarea>
